<template>
    <div class="withdraw-form">
        <div class="withdraw-form__wrapper">
            <table class="table table--collapse">
                <thead>
                    <tr class="table__head table__head--balance">
                        <th 
                            v-for="(h, index) of col" 
                            :key="index"
                        >{{h.label}}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="table__row table__row--balance">
                        ...
                        <td>
                            <b-button variant="primary" class="btn--full-width">Withdraw</b-button>
                        </td>
                    </tr>
                    <tr class="table__row table__row--balance">
                        <td 
                    ...
                    <tr v-if="note" class="table__row table__row--balance">
                        <td 
                            :colspan="col.length"
                        >{{note}}</td>
                    </tr>
